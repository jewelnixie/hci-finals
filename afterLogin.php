            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <div class="dropdown-menu" aria-labelledby="destinationDropdown">
                        ...
                        <a class="dropdown-item" href="destinationAfter.php">Beaches and Islands</a>
                        <a class="dropdown-item" href="destinationAfter.php">Mountains and Hiking Trails</a>
                        <a class="dropdown-item" href="destinationAfter.php">Cultural Gateways</a>
                        <a class="dropdown-item" href="destinationAfter.php">Theme Parks and Rides</a>
                    </div>
                    </li>
                    <!-- About Us -->
                    <li class="nav-item">
        ...
        <div class="homepage-section">
            <div class="left-side">
                <div class="text-content">
                    ...
                    <a href="book_tab.html" class="book-now-btn">Book Now</a> 
                </div>
            </div>
        ...
        <section class="promo-section">
            ...
            <div class="promo-grid">
                <div class="promo-card">
                    <img src="images/palawantour.png" alt="Island Hopping Adventure">
                ...
                <div class="promo-card">
                    <img src="images/siaotour.png" alt="Wedding and Honeymoon Package">
                ...
                <div class="promo-card">
                    <img src="images/vigantour.png" alt="Cultural Tour Special">
                ...
                <div class="promo-card">
                    <img src="images/boratour.png" alt="Beach Resort Escape">
                ...
                <div class="promo-card large">
                    <img src="images/cebu.png" alt="Special Promo">
                    ...
                    <div class="buttons">
                        <button onclick="location.href='book_tab.html'">Book now →</button>
            ...
            <div class="modal-dialog modal-dialog-centered" style="max-width: 850px;">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <img src="images/pawa.png" alt="" style="width: 820px; height: auto;"> <br><br>
        ...
        <div class="modal fade" id="viganModal" tabindex="-1" aria-labelledby="viganModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" style="max-width: 850px;">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <img src="images/viagaan.png" alt="">
                        <br> <br>
        ...
        <div class="modal fade" id="boracayModal" tabindex="-1" aria-labelledby="boracayModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" style="max-width: 850px;">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <img src="images/boracauy.png" alt="">
                        <br> <br>
        ...
        <div class="modal fade" id="cebuModal" tabindex="-1" aria-labelledby="cebuModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" style="max-width: 850px;">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <img src="images/cebuuuu.png" alt="">
                        <br> <br>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="delete.php" method="POST" style="display:inline;">
                                ...
                                <button type="submit" name="delete_favorite" class="btn btn-outline-danger">Remove from Favorites</button>
                            </form>
                        </div>
                    </div>
                </div>';
